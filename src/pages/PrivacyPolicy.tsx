        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="bg-card rounded-2xl shadow-card p-8 space-y-8 font-body text-foreground leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">To exercise any of these rights, contact us at <strong className="text-foreground">privacy@triplink.app</strong>.</p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">TripLink is not intended for users under 18. We do not knowingly collect data from minors.</p>
            </section>
            ...
            <div className="pt-4 border-t border-border">
              <p className="text-sm text-muted-foreground">Questions? Contact us at <strong className="text-foreground">privacy@triplink.app</strong></p>
            </div>
          </div>
        </motion.div>
      </div>
